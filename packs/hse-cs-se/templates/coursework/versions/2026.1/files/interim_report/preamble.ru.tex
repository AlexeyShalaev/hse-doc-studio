% !TeX program = xelatex
% ============================================================
% interim_report/preamble.tex — преамбула Промежуточного отчёта
% исследовательского курсового проекта ОП «Программная инженерия» (КТ1).
%
% Оформление наследует Отчёту (ГОСТ 7.32-2017, класс extreport): поля
% 30/15/20/20 (или Прил. 10 — по настройке report_margins), TNR 12 пт,
% интервал 1,5, абзац 1,25 см, сквозная нумерация рисунков/таблиц.
% ЧИСТЫЙ документ — БЕЗ штампа/рамки/листа утверждения.
% Данные — из common/meta (\hse…).
% ============================================================
