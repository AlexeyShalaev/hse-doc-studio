% ============================================================
% technical_specification/requirements_table.tex — таблица функциональных
% требований к системе (СКЕЛЕТ; заполняется студентом).
%
% Источник определений требований (\req) панели «Трассировка требований».
% Подключается из technical_specification.tex (\input{requirements_table})
% и test_program_and_methodology.tex
