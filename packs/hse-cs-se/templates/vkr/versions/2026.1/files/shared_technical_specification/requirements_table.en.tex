% ============================================================
% shared_technical_specification/requirements_table.tex — functional requirements
% table (SKELETON; filled in by the student).
%
% The SYSTEM-level requirements table of a team project (a separate
% document, not a copy of the personal one). Included from
% shared_technical_specification.tex (\input{requirements_table}) and
% shared_test_program_and_methodology.tex
